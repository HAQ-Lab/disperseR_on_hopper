...
#SBATCH --job-name=disperseR_2019-2020i_2.R
...
#SBATCH --mail-user=lhennem@gmu.edu     # Put your GMU email address here
...
Rscript /home/lhennem/runscripts/rundisperseR/01disperseR2019_2020.R 
